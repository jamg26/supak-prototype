...
<body>
    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <p class="fst-italic">click to view</p>
                        ...
                        <ul class="chat">
                            <li class="agent clearfix">
                                <span class="chat-img left clearfix mx-2">
                                    <img src="u.png" alt="Agent" class="img-circle" />
                                </span>
                            ...
                            <li class="admin clearfix">
                                <span class="chat-img right clearfix mx-2">
                                    <img src="me.png" alt="Admin" class="img-circle" />
                                </span>
                                <div class="chat-body clearfix">
                                    <div class="header clearfix">
                                        <small class="left text-muted"><span class="glyphicon glyphicon-time"></span> 1
                                            min
                                            ago</small>
